...
export const ui = {
  en: {
    ...
    'splash.motionGraphics': 'MOTION GRAPHICS',
    ...
    'about.badge.direction': 'DIRECTION',
    ...
    'works.illustration': 'ILLUSTRATION',
    'works.sort': 'Sort by',
    'works.newest': 'Newest',
    'works.oldest': 'Oldest',
  ...
  ja: {
    'splash.artDirection': 'アートディレクション',
    'splash.motionGraphics': 'モーショングラフィックス',
    ...
    'works.graphicsDesign': 'グラフィックデザイン',
    'works.illustration': 'イラスト',
    'works.sort': '並び替え',
    'works.newest': '新しい順',
    'works.oldest': '古い順',
    'works.featured': '注目',
  ...
  vi: {
    'splash.artDirection': 'CHỈ ĐẠO NGHỆ THUẬT',
    'splash.motionGraphics': 'ĐỒ HỌA CHUYỂN ĐỘNG',
